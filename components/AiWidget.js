...
//             <div className="rainbow-wrapper mb-6">
//   <div className="rainbow inline-flex p-[2px] rounded-full bg-gradient-to-r from-lime-400 via-red-500 via-blue-500 to-purple-600">
//     <div className="flex items-center gap-2 bg-white rounded-full px-5 py-2.5">
//       <Image src="/images/icons3.svg" alt="star" width={20} height={20} />
//       <span className="text-orange-600 font-bold text-sm tracking-wide whitespace-nowrap">
//         COMING SOON
...
export default function AiWidget() {
  ...
  return (
    ...
    >
      ...
      <div className="block md:hidden py-6 bg-[#FFFAF3]">
        <div
          className="relative overflow-hidden rounded-[24px] border  bg-cover bg-center bg-no-repeat shadow-sm pt-7 "
          style={{
            minHeight: '700px',
            backgroundImage: "url('/images/bg1.png')",
          }}
