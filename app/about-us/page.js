...
export default function AboutUs() {
  return (
    <div className="min-h-screen bg-[#FFFAF3] pt-0 pb-6 md:py-10">
      <div className="container mx-auto md:px-4  max-w-[1200px]">
        ...
        {/* Hero Section Card */}
        <div className="bg-[#164925] text-white md:rounded-[32px] p-6 md:p-12 lg:p-16 flex flex-col md:flex-row md:items-center  text-start justify-between gap-8 mb-12 md:mb-16 md:shadow-lg">
          <div className="space-y-6 md:max-w-[50%]">
            ...
            <p className="text-base md:text-lg text-[#FFFAF3] opacity-90 font-nunito leading-relaxed">
              Making Gardening <br />
              Simple, Smart & Accessible for Everyone
            </p>
          </div>
        ...
        {/* Content Sections */}
        <div className="max-w-[840px] mx-auto md:text-center text-left px-3 space-y-12 md:space-y-16 pb-16">
